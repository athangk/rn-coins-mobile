...
<p>Redux for persisting user state, expo secure storage for persisting token  "remember me" functionality on login.
 Asyncstorage for specific reducers with redux persist to keep user selection tracked coins.</p>

<p> Draggable selection of tracks that resets orders in redux</p>
